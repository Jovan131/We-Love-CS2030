...
export async function POST(input: any) {
  ...
  const verifyMsg = `Hello ${name}, please activate your account by clicking this link: http://localhost:3000/account?${activeToken}` //change link to production link (need to check Vercel config I am not sure yet)
